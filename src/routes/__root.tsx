  ...
  head: () => ({
    meta: [
      ...
      { title: "Skills Brand — Discover the Best Courses to Build Your Skills" },
      {
        name: "description",
        content:
          "Skills Brand curates and recommends the best online courses to help individuals and businesses grow with powerful skills and unforgettable brands.",
      },
      { name: "author", content: "Skills Brand" },
